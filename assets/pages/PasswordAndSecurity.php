        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Change Passowrd</h4>
                  
                  <form class="forms-sample" action="../PHP/editPassword.php" method="post">
                  
                    <div class="form-group">
                      <label for="exampleInputPassword4">Current Password</label>
                      <input type="password" class="form-control" id="Password1" name="Password1" placeholder="Current Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,100}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">New Password</label>
                      <input type="password" class="form-control" id="Password2" name="Password2" placeholder="New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,100}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Re-enter New Password</label>
                      <input type="password" class="form-control" id="Password3" name="Password3" placeholder="Re-enter New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,100}" required>
                    </div>
